		...
		if (strcmp($_POST['emailadd1'], $_POST['emailadd2']) == 0) {
			...
			if (strcmp($_POST['pass'], $_POST['confirmpass']) == 0) {
				...
				if ($result->num_rows > 0) {
					...
					// if email and password match then insert the data in the database
					...
					$q = "INSERT INTO user_tbl (firstname, lastname, middlename, emailadd, address, contact, username, pass, dateregistered, timeregistered, dateupdated, timeupdated) 
							values (?,?,?,?,?,?,?,?,?,?,?,?)";
