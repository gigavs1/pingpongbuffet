                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <?php
                                    ...
                                    $query = "SELECT COUNT(*) as total_rows FROM category_tbl";
                                    ...
                                    $query = "SELECT * FROM category_tbl ORDER BY categoryid LIMIT $offset, $items_per_page";
                                    $statement = $conn->prepare($query);
                                    $statement->execute();
                                    ...
                                    if ($res->num_rows > 0) {
                                        while ($rows = $res->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $rows['categorydescription']; ?></td>
                                                <td><?php echo $rows['categorydatecreated']; ?></td>
                                                <td><?php echo $rows['categorylastupdated']; ?></td>
                                                <td>
                                                    <center>
                                                    <!-- edit button that will direct editproduct page -->
                                                    <a href="editcategory.php?uid=<?php echo $rows['categoryid']; ?>" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-left:-135px;position:relative;top:10px;"></i></a>
                                                    <!-- delete button that will delete the row of the product -->
                                                    <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                                            <input type="hidden" name="categoryname" value="<?php echo $rows['categoryname']; ?>">
                                                            <button type="submit" name="btndeletecategory" class="btn btn-danger" data-toggle="tooltip" title="Trash" style="margin-right:25px;position:relative;bottom:18px;"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                    </form>
                                                    </center>
                                                </td>
                                            </tr>
                                    ...
                                    //query for deleting categories 
                                    if (isset($_POST['btndeletecategory'])) {
                                        
                                        $qdel = "DELETE FROM category_tbl WHERE categoryname=?";

                                        $s = $conn->prepare($qdel);

                                        $s->bind_param("s", $_POST['categoryname']);
