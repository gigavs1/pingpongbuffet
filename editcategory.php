...
<body>
            ...
            if ((isset($_POST['btncategoryupdate'])) && (isset($_SESSION['token']))) {
                ...
                $q = "UPDATE category_tbl SET categoryname=?, categorydescription=?, categorydatecreated=?, categorylastupdated=? WHERE categoryid=?";
        
                $statment = $conn->prepare($q);
        
                $statment->bind_param("sssss",$_POST['categoryname'],$_POST['categorydescription'],$datetoday,$datetoday,$_POST['uid']);
                  ...
                  echo "<div class='alert alert-success' role='alert'>
                          <center><h4 class='alert-heading'>Successful!</h4></center>
                            <hr>
                              ...
                              <center><a href='categorylist.php'><u>Go back to Category List<u></a></center>
                        </div>";
                } else {
                  echo "<div class='alert alert-danger' role='alert'>
                          <center><h4 class='alert-heading'>Unsuccessful!</h4></center>
                            <hr>
                              ...
                              <center><a href='categorylist.php'><u>Retry Again<u></a></center>
                        </div>";
                }
                ...
                $q = "SELECT * FROM category_tbl WHERE categoryid=?";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="text-center custom-login">
                                    <h3 class="text-info" style="font-size:30px;letter-spacing:5px;">Edit Category</h3><br>
                                </div>
                                <div class="hpanel">
                                        ...
                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id="loginForm" style="padding:20px 20px 70px 20px;">
                                            ...
                                            <input type="hidden" value="<?php echo $uid; ?>" name="uid">
                                                ...
                                                <div class="form-group col-lg-12">
                                                    ...
                                                    <input type="text" class="form-control" name="categoryname" value="<?php echo $rows['categoryname']; ?>">
                                                </div>

                                                <div class="form-group col-lg-12">
                                                    <label>Category Description</label>
                                                    <textarea class="form-control" rows="5" name="categorydescription"><?php echo $rows['categorydescription']; ?></textarea>
                                                    <!-- <input type="text" class="form-control" name="categorydescription" value=""> -->
                                                </div>

                                            </div>
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-success" name="btncategoryupdate" style="position:relative; top:40px; right:3px; padding:1% 45% 1% 45%;">Edit Category</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
