                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard" href="admin.php"><span class="mini-sub-pro">Dashboard</span></a></li>
                                <li><a title="User's List" href="userlist.php"><span class="mini-sub-pro">User List</span></a></li>
                                <li><a title="Category List" href="categorylist.php"><span class="mini-sub-pro">category List</span></a></li>
                                <li><a title="Add Category" href="addcategory.php"><span class="mini-sub-pro">Add Category</span></a></li>
                                <li><a title="Product List" href="productlist.php"><span class="mini-sub-pro">Product List</span></a></li>
                                <li><a title="Add Product" href="addproduct.php"><span class="mini-sub-pro">Add Product</span></a></li>                        
                            </ul>
                        </li>
                        <li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>User</h2>
												<p>Welcome to Pingpong Buffet Admin</p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <?php
                                    ...
                                    $query = "SELECT COUNT(*) as total_rows FROM user_tbl";
                                    ...
                                    $query = "SELECT * FROM user_tbl ORDER BY userid LIMIT $offset, $items_per_page";
                                    $statement = $conn->prepare($query);
                                    $statement->execute();
                                    ...
                                    if ($res->num_rows > 0) {
                                        while ($rows = $res->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $rows['dateregistered']; ?></td>
                                                <td><?php echo $rows['dateupdated']; ?></td>
                                                <td>
                                                    <center>
                                                        <a href="updateuser.php?uid=<?php echo $rows['userid']; ?>" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                    </center>
                                                </td>
                                            </tr>
                                            <?php
